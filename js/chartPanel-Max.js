(function(){
	window.ChartPanel_Max = Backbone.View.extend({
		...
		initialize: function () {
	  	...
	  	render: function () {
	    	$(this.el).html(_.template($('#chartPanel-Max-template').html()));
	  	},
	  	defField: function(){
			...
			row2 = '<param name=\"movie\" value=\"http://www.traders-sns.com/ivc/open-flash-chart.swf?width='+ wide +'&height=' + high + '&data=http://www.traders-sns.com/ivc/data/chart-data_2y.php\" />\n';
			row3 = '<embed src=\"http://www.traders-sns.com/ivc/open-flash-chart.swf?data=http://www.traders-sns.com/ivc/data/chart-data_2y.php\" quality=\"high\" bgcolor=\"#FFFFFF\" width=\"' + wide + '\" height=\"' + high + '\" name=\"chart\" align=\"middle\" allowScriptAccess=\"sameDomain\" type=\"application/x-shockwave-flash\" pluginspage=\"http://www.macromedia.com/go/getflashplayer\" id=\"chart\"/>\n';
			copy_w = wide - 25;
